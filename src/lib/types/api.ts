...
import type { AssemblyLineItem } from "../core/session/create-assembly-line";
import type {
  PremadeStockItem,
...
export type LoginResponse = DataResponse<typeof profiles.$inferSelect | null>;
export type LogoutResponse = DataResponse<"success">;
...
export type GetProductVariantsResponse = DataResponse<
