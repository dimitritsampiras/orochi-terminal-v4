...
export default function EditProductForm({
	...
	const handleSubmit: SubmitHandler<EditProductSchema> = async (data) => {
	...
	useEffect(() => {
		if (isOpen) {
			form.reset({
				...
				upsellIds: product.upsellProducts.map((product) => product.id),
			});
		} else {
			form.reset();
		}
			...
			<SheetContent>
				<div className="h-full w-full flex flex-col">
					<SheetHeader className="border-b">
						...
						<SheetDescription>
							Edit the product with the following details.
						</SheetDescription>
					</SheetHeader>
							...
							<div className="flex-1 overflow-y-scroll pb-20 px-4 flex flex-col gap-5 pt-4">
									...
									render={({ field }) => {
										return (
											<FormItem>
												...
												<FormDescription>
													Select the category(s) for this product. You can also
													add new categories.
												</FormDescription>
												<FormControl>
											...
											<FormItem>
												...
												<FormControl>
													<SearchProductsMultiSelect
														currentUpsellSelection={product.upsellProducts}
														maxSelections={3}
								...
								<Alert>
									...
									<AlertDescription className="text-xs">
										...
										Stock" option to edit stock levels.
									</AlertDescription>
								</Alert>
							</div>
