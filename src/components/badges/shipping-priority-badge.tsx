...
function ShippingPriorityBadge({ status, className }: { status: ShippingPriority; className?: string }) {
  const colorMap: Record<ShippingPriority, string> = {
    express: "bg-violet-100 text-violet-800 hover:bg-violet-200",
    fastest: "bg-blue-100 text-blue-800 hover:bg-blue-200",
    standard: "bg-zinc-100 text-zinc-800 hover:bg-zinc-200",
  };
