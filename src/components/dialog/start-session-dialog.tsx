        ...
        {data && (
          <div className="space-y-4 px-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Badge className="bg-green-100 text-green-800">{printCount} to print</Badge>
              <Badge className="bg-blue-100 text-blue-800">{stockCount} stock</Badge>
            ...
            {data.filteredItems?.length > 0 && (
              <div>
                ...
                <div className="bg-zinc-50 border rounded p-2 text-xs max-h-32 overflow-y-auto space-y-1">
            ...
            <div>
              ...
              <div className="border rounded overflow-y-auto text-xs max-h-56">
            ...
            <Alert>
              ...
              <AlertDescription>
                Starting the session will:
                <ul className="list-disc w-full px-4">
                  <li> Reduce the stock of overstocked items by 1</li>
                  <li>Create a final Picking List & Sorting/Assembly List</li>
                  <li>Generate an initial merged packing slips for the shipments.</li>
                </ul>
              </AlertDescription>
            </Alert>
          </div>
